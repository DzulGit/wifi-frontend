...
export default function NotifikasiPage() {
  ...
  const getNotificationIcon = (type: string) => {
    ...
    // Kita sesuaikan dengan type yang dikirim backend: BILLING, WARNING, INFO
    if (t === 'BILLING') {
      return (
          ...
          {isLoading ? (
            ...
            Array(4)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-[#1A1A1A] border border-white/5 p-6 rounded-[1.5rem] flex items-start gap-4 animate-pulse"
                >
            ...
            <div className="bg-[#1A1A1A] border border-white/5 rounded-[2rem] p-16 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-white/40">
                Anda akan mendapatkan pemberitahuan di sini jika ada informasi
                terbaru.
              </p>
            </div>
          ) : (
              ...
              >
                ...
                <div className="flex-1 pr-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-4 mb-1.5">
                    <h4
                      className={`text-base font-bold ${!notif.isRead ? 'text-white' : 'text-white/80'}`}
                    >
                      {notif.title}
                    </h4>
