...
import { RefreshCw, TrendingUp, Users, CreditCard, FileText } from 'lucide-react'
import {
              ...
              <tbody className="divide-y divide-gray-50">
                {[
                  ...
                  <tr key={String(cat)} className={i % 2 === 0 ? '' : 'bg-gray-50/30'}>
                    ...
                    <td className="px-5 py-3.5">
                      <span className={`text-sm font-medium ${String(warn).startsWith('0') ? 'text-gray-400' : 'text-red-500'}`}>{warn}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
